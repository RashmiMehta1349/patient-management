...
/// GET-by-id doesn't exist until Increment 2, so "immediately retrievable" is verified by
/// querying the test DbContext directly rather than via a follow-up GET request.
/// </summary>
